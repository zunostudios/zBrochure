 ...
 */
class ZbrochureViewClient extends JView{
	...
	function display( $tpl = null ){
		...
		$this->list_menu_itemid		= $this->_getMenuItemId( 'com_zbrochure', 'clients', true );
		$this->item_menu_itemid		= $this->_getMenuItemId( 'com_zbrochure', 'client' );
