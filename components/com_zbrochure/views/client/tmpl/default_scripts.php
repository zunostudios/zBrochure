...
function createUploader(){
    ...
    var uploader = new qq.FileUploader({
        ...
        action: 'index.php?option=com_zbrochure&task=uploadPreview&context=client',
