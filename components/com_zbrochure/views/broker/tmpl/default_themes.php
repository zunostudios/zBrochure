				...
				<td>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%" class="theme-table">
						...
						<tr id="preview-container-<?php echo $theme->theme_id; ?>" class="theme-preview">
							...
							<?php if( $theme->theme_id == $this->broker->broker_version_theme ){ ?>
								<td class="first" width="10"><input type="radio" id="themeid_<?php echo $theme->theme_id; ?>" name="broker_version_theme" value="<?php echo $theme->theme_id; ?>" checked="checked" /></td>
							<?php }else{ ?>
								<td class="first" width="10"><input type="radio" id="themeid_<?php echo $theme->theme_id; ?>" name="broker_version_theme" value="<?php echo $theme->theme_id; ?>" /></td>
							<?php } ?>
