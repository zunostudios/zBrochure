...
<div class="bro-preview">
	...
	<div id="preview-left" class="preview-left-col">
		...
		<div id="preview-left-img">
			<?php echo JHTML::_( 'image.site', $this->pages[0]->bro_page_thumb, '/media/zbrochure/docs/'.$this->pages[0]->bro_id.'/th/', '', '', $this->pages[0]->bro_title . ' thumbnail', '' ); ?>
		</div>
		...
		<div id="preview-thumbs">
			...
			foreach( $this->pages as $page ){ ?>
				...
				<li class="tmpl-layout-th preview-page" id="bro-page-th-<?php echo $page->bro_page_id; ?>" rel="<?php echo JURI::base().'media/zbrochure/docs/'.$this->bro->bro_id.'/th/'.$page->bro_page_thumb; ?>"><?php echo JHTML::_( 'image.site', $page->bro_page_thumb, '/media/zbrochure/docs/'.$page->bro_id.'/th/', '', '', $page->bro_title . ' thumbnail', 'width="90" height="116"' ); ?></li>
...
for( $i = 1; $i <= $this->bro->bro_pages; $i++ ){
				...
				if( $this->pages[$i] ){
					...
					<li class="tmpl-layout-th preview-page" id="bro-page-th-<?php echo $this->page->bro_page_id; ?>" rel="<?php echo JURI::base().'media/zbrochure/docs/'.$this->bro->bro_id.'/'.$this->page->bro_page_thumb; ?>"><?php echo JHTML::_( 'image.site', $this->page->bro_page_thumb, '/media/zbrochure/docs/'.$this->page->bro_id.'/th/', '', '', $this->page->bro_title . ' thumbnail', 'class="'.$class.'" width="90" height="116"' ); ?></li>
