...
/**
 * HTML View class for Category Listing
 */
class ZbrochureViewCategories extends JView {
	...
	function display( $tpl = null ){
		...
		$this->list_menu_itemid		= $this->_getMenuItemId( 'com_zbrochure', 'categories' );
		$this->item_menu_itemid		= $this->_getMenuItemId( 'com_zbrochure', 'category', true );
