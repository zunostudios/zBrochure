...
$(document).ready(function(){
	...
	$( '#themes li.theme' ).each(function(index){
		...
		$(this).click(function(){
			...
			$( '#tmpl_default_theme' ).val( $(this).attr( 'zid' ) );
	...
	$('#generate-btn').click(function(){
		...
		$.ajax({
			...
			url: 'index.php?option=com_zbrochure&task=generateTemplateDoc&id=<?php echo $this->tmpl->tmpl_id; ?>&store_pdf=1&return_link=1',
			type: 'POST'
	...
	function generate( item ){
		...
		$.ajax({
			...
			type: 'POST',
			url: 'index.php',
			data: 'option=com_zbrochure&task=generateTemplateThumb&tid=<?php echo $this->tmpl->tmpl_id; ?>&pid='+pid
