...
<div class="page page-with-content tmpl-page<?php //echo ( $this->spread ) ? ' spread-'.$this->spread_side : '' ; ?>" zid="<?php echo $this->page->bro_page_id; ?>" lid="<?php echo $this->page->tmpl_layout_id; ?>" lkey="<?php echo $this->page->tmpl_layout_key; ?>" zpage="<?php echo $this->page->page_number; ?>" id="page-<?php echo $this->page->page_number; ?>" style="width:<?php echo $this->page->width.''.$this->page->unit_of_measure;?>;height:<?php echo $this->page->height.''.$this->page->unit_of_measure;?>">
<?php
